          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <Card className="p-8 bg-white text-[#0A4B3C] h-full flex flex-col">
                ...
                <h3 className="font-bold mb-4 text-center">Donate with Bitcoin</h3>
                <p className="text-sm text-gray-600 mb-4 text-center flex-grow">
                  Support our mission by donating Bitcoin and other cryptocurrencies.
                </p>
                <NOWPaymentsButton className="w-full bg-[#0A4B3C] hover:bg-[#0A4B3C]/90 text-white">
                  Donate Now
                </NOWPaymentsButton>
              </Card>
            </motion.div>
